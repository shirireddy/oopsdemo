...
class CheckingAccount extends Account{
    double overDraft; //ready to use loan
    public CheckingAccount(String str,double bal,double overDraft) { //when he required od this cons is used
        super(str, bal);
        this.overDraft = overDraft;
    }
    void withdraw(double amt) { //overridden method
